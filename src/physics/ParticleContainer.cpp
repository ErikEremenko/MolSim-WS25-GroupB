...
Particle* ParticleContainer::addParticle(std::array<double, 3> x, std::array<double, 3> v, double m, int type,
...
Particle* ParticleContainer::addParticle(std::array<double, 3> x, std::array<double, 3> v, double m,
                                         std::array<double, 3> f, std::array<double, 3> oldF, int type, double sigma,
                                         double epsilon) {
